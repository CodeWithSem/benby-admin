...
const P2_10_TDS_TAGGING_INDEX = ({ set_page_display }) => {
  ...
  return (
    <React.Fragment>
      <div
        className="admin-page-container content-center"
        style={{ gap: "2vh" }}
      >
        <div className="h-100" style={{ position: "relative", width: "50%" }}>
          {/* + PAGE LABEL */}
...
export default P2_10_TDS_TAGGING_INDEX;
